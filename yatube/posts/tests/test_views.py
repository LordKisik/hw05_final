...
class PostTests(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.post2 = Post.objects.create(
            author=User.objects.create_user(username='admin222',
        ...
        cls.post3 = Post.objects.create(
            author=User.objects.create_user(username='admin333',
...
class PaginatorViewsTest(TestCase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        NUMBER_OF_POSTS = 13
        cls.author = User.objects.create_user(username='admin111',
                                              password='Admin111admin',)
    ...
    def test_second_page_contains_three_posts(self):
        ...
        list_urls = [
            ...
            reverse('posts:profile',
                    kwargs={'username': 'admin111'}) + '?page=2'
        ]
        for tested_url in list_urls:
            response = self.client.get(tested_url)
            self.assertEqual(
